...
func (c *sayHelloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloRequest, error) {
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *HelloRequest) (*HelloRequest, error) {
